...
print(len(symptoms))
desc=pd.read_csv("C:/Users/User/Desktop/medical/dataset/symptom_Description.csv")
prec=pd.read_csv("C:/Users/User/Desktop/medical/dataset/symptom_precaution.csv")
app = Flask(__name__)
CORS(app)
